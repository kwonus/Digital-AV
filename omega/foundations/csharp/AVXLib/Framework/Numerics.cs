namespace AVXLib.Framework
{
    public abstract class Numerics
    {
        ...
        public abstract class POS12
        {
            ...
            public const UInt16 PronounOrNoun_Genitive_MASK = (UInt16)(PronounOrNoun_Genitive | Noun | Pronoun);
            public const UInt16 Noun_Genitive               = (UInt16)(PronounOrNoun_Genitive | Noun);
            public const UInt16 Pronoun_Genitive            = (UInt16)(PronounOrNoun_Genitive | Pronoun);
        ...
        {
            public const byte EndBit = 0x10;
            public const byte BeginningOfVerse = 0x20;
            public const byte EndOfVerse = 0x30;
            public const byte BeginningOfChapter = 0x60;
            public const byte EndOfChapter = 0x70;
            public const byte BeginningOfBook = 0xE0;
            public const byte EndOfBook = 0xF0;
            public const byte BeginningOfBible = 0xE8;
            public const byte EndOfBible = 0xF8;
        }
