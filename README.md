...
The Digital AV is an software development kit (SDK) for the Authorized Version (AV) of the King James Bible. It was digitally released in 2008, but with bug fixes and minor revisions it became known as the 2011 edition.  The original SDK was just three binary files and a document that described the binary record layouts.  The final release of 2011 edition was 2017-08-15
